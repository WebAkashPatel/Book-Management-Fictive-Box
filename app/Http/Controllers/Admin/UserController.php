    ...
    public function data(Request $request)
    {
        ...
        return datatables()->of($data)->addColumn('action', function ($data) {
            ...
            if ($data->is_active == 'Yes') {
                $button .= '<a href="javascript:void()" name="disable" data-value="' . $data->id . '" class="status-btn btn btn-sm btn-danger">Inactive</a>';
            } else {
                $button .= '<a href="javascript:void()" name="enable" data-value="' . $data->id . '" class="status-btn btn btn-sm btn-success">Active</a>';
            }
            $button .= '</div>';
